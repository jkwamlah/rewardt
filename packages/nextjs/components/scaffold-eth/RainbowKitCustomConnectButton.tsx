                  ...
                  <>
                    <div className="dropdown dropdown-primary">
                      ...
                      >
                        ...
                        <a className="dropdown-item text-dark" href="#" onClick={() => disconnect()}>
                ...
                <>
                  <div className="px-2 d-flex justify-content-end items-center">
                    <div className="dropdown dropdown-primary">
                      ...
                      >
                        <div
                          className="dropdown-item text-muted p-0"
                          id="account-info"
                          onClick={e => e.stopPropagation()}
                        >
                          <div className="bg-soft-primary rounded p-2 d-flex align-items-center justify-content-center">
                            <div className="d-block justify-content-center">
                              ...
                              <div className="text-muted">
                                <Balance
                                  ...
                                  className="btn btn-outline-light justify-content-center"
                                />
                              </div>
                            </div>
                          </div>
                        ...
                        <Link className="dropdown-item text-dark mt-3" href="/dashboard">
                          <i className="uil uil-user align-middle me-1" /> Dashboard
                        </Link>
                        <Link className="dropdown-item text-dark" href="#" onClick={openChainModal}>
                          <i className="uil uil-clipboard-notes align-middle me-1" />
                          Switch Networks
                        </Link>
                        <div className="dropdown-divider my-3 border-top" />
                        <a className="dropdown-item text-dark" href="#" onClick={openAccountModal}>
