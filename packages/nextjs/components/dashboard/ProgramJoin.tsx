...
const ProgramJoin: React.FC<ProgramCreateProps> = (resourceCreated) => {
    ...
    return (
        <div className="col-lg-12 mt-3">
            {showAlert &&
                <div className={`alert alert-dismissible fade show text-capitalize 
                ${alertType === 'error' ? 'bg-soft-danger' : 'bg-soft-primary'}`} role="alert">
                    {alertMessage}
                            ...
                            <div className="col-lg-6">
                                <div className="mb-3">
                                    ...
                                    <div className="form-icon position-relative">
                                        ...
                                        <input name="externalId" id="externalId" type="text"
