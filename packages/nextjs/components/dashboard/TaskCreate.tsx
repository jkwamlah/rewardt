...
const TaskCreate: React.FC<RewardCreateProps> = (rewardTypes) => {
    ...
    const handleChange = (event: React.ChangeEvent<HTMLSelectElement> | React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>) => {
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="form-icon position-relative">
                                        ...
                                        <input name="tokens" id="token" type="number" className="form-control ps-5"
                                               ...
                                               value={formData.tokens} disabled
                                               onChange={(event) => handleChange(event)}/>
                                    </div>
                                </div>
                            </div>
