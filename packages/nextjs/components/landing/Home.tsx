            ...
            <div className="modern-app-bg-shape position-relative">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="flex-1 ms-3">
                        ...
                        <p className="fs-5 text-dark fw-bold mb-0">
                          ...
                          <span className="text-muted" data-target="ETH">
                            {" "}
                            ETH
                          </span>
                        </p>
              ...
              <div className="modern-app-absolute-right">
                <div className="card rounded shadow">
                  <div className="p-3">
                    <div className="d-flex align-items-center">
                      <div className="avatar avatar-small rounded-pill shadow-md bg-soft-primary" />
              ...
              <div className="position-absolute top-100 start-100 translate-middle">
                <p className="avatar avatar-small bg-primary rounded-pill mb-0 zoom-in-out" style={{ opacity: 0.05 }} />
              </div>
            </div>
          </div>
        </div>
